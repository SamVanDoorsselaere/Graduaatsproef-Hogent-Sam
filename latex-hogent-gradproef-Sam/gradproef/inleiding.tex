...
In Hoofdstuk~\ref{ch:methodologie} wordt de methodologie toegelicht en worden de gebruikte onderzoekstechnieken besproken, waaronder de keuze voor React Native en de opzet van de server-tussenlaag.

In Hoofdstuk~\ref{ch:analyse} (Analyse) bespreken we de functionele behoeften van Energytix en hoe de data-architectuur is opgebouwd.

In Hoofdstuk~\ref{ch:technologie} wordt dieper ingegaan op de gebruikte technologie-stack zoals Expo, Axios en PostgreSQL.

In Hoofdstuk~\ref{ch:implementatie} (Implementatie) wordt de effectieve realisatie en styling van de app besproken, inclusief de uitdagingen bij cross-platform ontwikkeling.

In Hoofdstuk~\ref{ch:conclusie}, tenslotte, wordt de conclusie gegeven en een antwoord geformuleerd op de onderzoeksvragen, samen met aanbevelingen voor verdere uitbreidingen van de applicatie.